			...
			<div class="grid wide">
				<div class="row container__row">
					...
					<div class="container__col container__col--info col l-7 c-12 m-12">
						...
						<form id="soluongmua"
							action="GioHang?ht=1&msp=${masanpham }&tsp=${tensanpham }&anh=${anh }&gb=${giaban }&gg=${giagiam }&sldb=${soluongdaban }&mtsp=${motasanpham }&ml=${maloai }&mth=${mathuonghieu }&mdm=${madanhmuc}&acs=${anhchonsize}"
							method="post"></form>
						<div class="container__row-info row">
							<div class="container__col--info-left col l-4 m-4 c-4">
